...
export default function PayerMixCTASection() {
  return (
    <section className="py-16 md:py-20 bg-[#F1F5F9] border-t border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white border border-[#D9D9D9] rounded-3xl p-8 sm:p-12 shadow-md relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 space-y-4">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#203858] leading-tight">
                Your Payer Mix Matters — Stop Allowing Underpayments to Slip Through
              </h2>

              <p className="text-base text-charcoal-primary max-w-2xl leading-relaxed">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <div className="flex items-center gap-2 text-sm text-[#203858] font-medium">
            ...
            <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-4 justify-center items-stretch">
              <a
                ...
                className="min-h-[48px] px-6 py-3.5 rounded-xl text-base font-bold text-neutral-white bg-[#203858] hover:bg-[#304F78] shadow-md hover:shadow-lg transition-all flex items-center justify-center text-center"
              >
              ...
              <a
                ...
                className="min-h-[48px] px-6 py-3.5 rounded-xl text-base font-semibold text-[#203858] bg-slate-100 hover:bg-slate-200 border border-[#D9D9D9] transition-all flex items-center justify-center text-center"
              >
